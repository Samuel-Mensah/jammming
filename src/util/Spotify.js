const clientId = 'c1928075af334dfc9a9d34f02f971e20';
const redirectUri = 'http://absorbed-twist.surge.sh';
...
const Spotify = {
    getAccessToken() {
        ...
        if (accessTokenMatch && expiresInMatch){
         ...
         //This clears the parameters, allowing us to grab new acces token when it expires
